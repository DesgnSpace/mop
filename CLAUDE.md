# Claude Development Notes for MOP
...
- When developing and testing changes, run the app in background using: `swift build && swift run MOP` with `run_in_background: true`
